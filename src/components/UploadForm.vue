          ...
          <v-container class="form-content">
            <v-row>
              ...
              <p class="text-center pa-4">
                ...
                monitoring locations within a 'namespace' <i>(short name for your organization)</i>. The
                features you link to must already exist online and have their own web page.
              </p>
              <v-alert color="info" class="mb-2" icon="$info" variant="tonal" title="Additional details ">
                For more details, the <a href="https://docs.geoconnex.us/">geoconnex documentation</a> provides a
                general
                overview of geoconnex and a tutorial for how to:
                <ol>
                  <li> 1. <a href="https://docs.geoconnex.us/contributing/step-1/idscheme"> Prepare your data</a> with
                    the proper metadata context </li>
                  <li> 2. Host your data, if you have not done so already, with <a
                      href="https://docs.geoconnex.us/contributing/step-2/">individual web pages</a> that can be linked
                    to as the "target" column in your uploaded CSV </li>
                  <li> 3.<a href="https://docs.geoconnex.us/contributing/step-3/minting"> Submit your CSV data</a>,
                    either here or Github, after checking it is <a
                      href="https://docs.geoconnex.us/reference/data-formats/csv-submissions/"> properly formatted</a>
                  </li>
                </ol>
                  ...
                  <v-expansion-panel title="CSV Formatting Reference" bg-color="#f4f4f9" value="1">
                    <v-expansion-panel-text class="expansion-panel text-1b335f">
                      <v-card-text class="markdown-card-text text-center pa-0 ma-0">
                        <v-row>
                          <i class="pa-4">Ensure your identifiers are well-documented and all info is up-to-date
                        ...
                        <div class="d-flex space-between mt-3">
                          <p><b><code>id </code></b> <br> <i>(The ID within geoconnex that your data should map to.)</i>
                          </p>
                          <p><b><code>target </code></b> <br> <i>(The URL to your data.)</i></p>
                          <p><b><code>creator </code></b> <br> <i>(A contact email for someone associated with the
                              data)</i></p>
                          <p><b><code>description </code></b> <br> <i>(A description of your data.)</i></p>
                        </div>
              ...
              <v-col cols="12" md="4">
                <v-text-field v-model="namespace" label="Namespace" hint="Example: usgs" variant="outlined"
                  required></v-text-field> </v-col><v-col cols="12" md="8">
